...
data class StoredTaskUpdatePayload(
    ...
    fun toApiPayload(): ApiTaskUpdatePayload = ApiTaskUpdatePayload(
        ...
        startTime = if (hasStartTime) startTime else null,
    ...
    fun merge(newer: StoredTaskUpdatePayload): StoredTaskUpdatePayload = copy(
        ...
        startTime = if (newer.hasStartTime) newer.startTime else startTime,
        hasStartTime = hasStartTime || newer.hasStartTime,
        endTime = if (newer.hasEndTime) newer.endTime else endTime,
        hasEndTime = hasEndTime || newer.hasEndTime,
